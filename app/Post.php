...
class Post extends Model
{
    ...
    protected $guarded = ['name','price','description','location', 'main_image', 'number_of_bedroom', 'number_of_bathroom','area', 'property_type_id', 'building_age', 'transaction_type','slug', 'user_id']; // Lấy hết các trường trong bảng đó
